...
* https://github.com/kiranjagtap/Cracking-Coding-Interview/blob/master/src/Strings/StringPermutation.java[*Check Permutation:*] Given two strings, write a method to decide if one is a permutation of the
other.


* https://github.com/kiranjagtap/Cracking-Coding-Interview/blob/master/src/Strings/URLify.java[*URLify:*] Write a method to replace all spaces in a string with '%2e: You may assume that the string has sufficient space at the end to hold the additional characters, and that you are given the "true" length of the string. 
...
* https://github.com/kiranjagtap/Cracking-Coding-Interview/blob/master/src/Strings/StringCompression.java[*String Compression:*] Implement a method to perform basic string compression using the counts of repeated characters. For example, the string aabcccccaaa would become a2blc5a3. If the
