...
import Utils.FullStackException;

/**
 * Describe how you could use a single array to implement three stacks. Approach
...
public class ThreeInOneMultiStack {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("Final Stack: "
				+ AssortedMethods.arrayToString(stacks.getValues()));
	}
	 ...
	 * just a bunch of individual variables, but thats messy and doesn't gain us
	 * much.
	 */
