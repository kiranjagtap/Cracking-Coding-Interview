...
public class DeleteMiddleNode {
	...
	public static void main(String[] args) {
		Node<Integer> head = AssortedMethods.randomLinkedList(10, 0, 10);
	 ...
	 * You only have access to that node. The solution is simply to copy the
	 * data from the next node over to the current node, and then to delete the
	 * next node. Note that this problem cannot be solved if the node to be
